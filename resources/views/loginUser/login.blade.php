    ...
    <div class="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-lg transition-colors duration-500">
        ...
        <form class="mt-6" action="{{ route('loginUser') }}" method="POST">
            ...
            <div>
                ...
                <input type="email" name="email" placeholder="Correo Electrónico" class="w-full px-4 py-3 rounded-lg bg-gray-200 dark:bg-gray-700 mt-2 border focus:border-blue-500 focus:bg-white dark:focus:bg-gray-600 focus:outline-none" required>
            </div>
        
            <div class="mt-4">
                <label class="block text-gray-700 dark:text-gray-300">Contraseña</label>
                <input type="password" name="password" placeholder="Contraseña" minlength="6" class="w-full px-4 py-3 rounded-lg bg-gray-200 dark:bg-gray-700 mt-2 border focus:border-blue-500 focus:bg-white dark:focus:bg-gray-600 focus:outline-none" required>
            </div>
        ...
        <p class="mt-8 text-gray-500 dark:text-gray-400">
            ...
            <a href="{{route('register.form')}}" class="text-blue-500 hover:text-blue-700 dark:hover:text-blue-400 font-semibold">Crear Cuenta</a>
        </p>
