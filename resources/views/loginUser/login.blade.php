...
<body class="bg-white dark:bg-gray-900 transition-colors duration-500 flex items-center justify-center h-screen">
    ...
    <section class="w-full max-w-md px-6 lg:px-16 xl:px-12">
        <div class="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-lg transition-colors duration-500">
            ...
            <h1 class="text-xl md:text-2x3 font-bold leading-tight mt-4 text-gray-800 dark:text-gray-100">Inicia Sesión
            </h1>
            ...
            <form class="mt-6" action="{{ route('loginUser') }}" method="POST">
                ...
                <button type="submit"
                    class="w-full block bg-blue-500 hover:bg-blue-400 dark:hover:bg-blue-600 text-white font-semibold rounded-lg px-4 py-3 mt-6">Acceder</button>
            </form>
            ...
            <p class="mt-8 text-gray-500 dark:text-gray-400">
                ...
                <a href="{{ route('register.form') }}"
                    class="text-blue-500 hover:text-blue-700 dark:hover:text-blue-400 font-semibold">Crear Cuenta</a>
            </p>
