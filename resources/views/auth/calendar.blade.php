                ...
                <div class="flex flex-col sm:flex-row justify-between items-center mb-4 space-y-2 sm:space-y-0">
                    <div class="flex space-x-2">
                        <select id="searchAttribute" class="px-3 py-2 border rounded-lg">
                            ...
                            <option value="password">Fecha de la compra</option>
                            <option value="role">Total</option>
                            <option value="role">Subtotal</option>
                        </select>
                    ...
                    <table class="min-w-full bg-white border rounded-lg">
                        <thead>
                            <tr class="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                                ...
                                <th class="py-3 px-6 text-left">Fechad de la compra</th>
                        ...
                        <tbody class="text-gray-700 text-sm font-light">
                            @foreach ($shopping as $shop)
                                ...
                                <tr class="border-b border-gray-200 hover:bg-gray-100">
                                    <td class="py-2 sm:py-3 px-3 sm:px-6 text-left">{{ $shop->id }}</td>
                                    <td class="py-2 sm:py-3 px-3 sm:px-6 text-left">{{ $shop->keyproduct }}</td>
                                    <td class="py-2 sm:py-3 px-3 sm:px-6 text-left">{{ $shop->username }}</td>
                                    <td class="py-2 sm:py-3 px-3 sm:px-6 text-left">{{ $shop->datebuy}}</td>
                                    <td class="py-2 sm:py-3 px-3 sm:px-6 text-left">{{ $shop->total }}</td>
                                    <td class="py-2 sm:py-3 px-3 sm:px-6 text-left">{{ $shop->subtotal }}</td>
                                <!--<td class="py-2 sm:py-3 px-3 sm:px-6 text-left">img</td>
                                    ...
                                    <td class="py-2 sm:py-3 px-3 sm:px-6 text-center">
                                        <div class="flex item-center justify-center space-x-2">
                                            <a href="/auth/shopping/{{$shop->id}}/eliminar">
                                                <i
