        ...
        <div class="w-full max-w-lg bg-white rounded-lg shadow-md p-6">
            ...
            <div class="flex justify-center mb-4">
                <label for="profileImage" class="cursor-pointer">
                    <img id="profileImagePreview" src="/img/cindy.jpg"
                        alt="Imagen de perfil" class="w-32 h-32 rounded-full object-cover border-4 border-gray-300">
            ...
            <form class="space-y-4" method="POST" action="{{ route('updateProfile') }}">
                @csrf
                <!-- Campo de nombre -->
                <div>
                ...
                <div>
                    ...
                    <input type="email" name="email"
                        class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:border-blue-500"
                        placeholder="Correo del usuario" value="{{ $user->email }}">
                </div>
