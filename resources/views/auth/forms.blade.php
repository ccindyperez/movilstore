                        ...
                        <tbody class="text-gray-700 text-sm font-light">
                            @foreach ($user as $usuario)
                                ...
                                <tr class="border-b border-gray-200 hover:bg-gray-100">
                                    <td class="py-2 sm:py-3 px-3 sm:px-6 text-left">{{ $usuario->id }}</td>
                                    <td class="py-2 sm:py-3 px-3 sm:px-6 text-left">{{ $usuario->name }}</td>
                                    <td class="py-2 sm:py-3 px-3 sm:px-6 text-left">{{ $usuario->email }}</td>
                                    <td class="py-2 sm:py-3 px-3 sm:px-6 text-left">{{ $usuario->password}}</td>
                                    <td class="py-2 sm:py-3 px-3 sm:px-6 text-left">{{ $usuario->role }}</td>
                                <!--<td class="py-2 sm:py-3 px-3 sm:px-6 text-left">img</td>
                                    ...
                                    <td class="py-2 sm:py-3 px-3 sm:px-6 text-center">
                                        <div class="flex item-center justify-center space-x-2">
                                            <a href="/auth/forms/{{$usuario->id}}/edit">
                                                <i
                                            ...
                                            <a href="/auth/forms/{{$usuario->id}}/eliminar">
                                                <i
